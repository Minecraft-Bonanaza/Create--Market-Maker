...
import com.bng.marketcoordination.economy.TraderHistoryService;
...
import com.bng.marketcoordination.purchasing.DemandCurveService;
...
import com.bng.marketcoordination.purchasing.VillagerBudgetService;
...
public final class MarketServices {
    ...
    public static final VillagerBudgetService VILLAGER_BUDGET = new VillagerBudgetService();
    public static final DemandCurveService DEMAND = new DemandCurveService();
    public static final TraderHistoryService TRADER_HISTORY = new TraderHistoryService();
